...
ST2_OBJS=./src/arch/x86/stage2/start.o ./src/arch/x86/stage2/int86.o ./src/arch/x86/stage2/main.o ./src/arch/x86/stage2/intterupts.o ./src/arch/x86/stage2/multiboot2.o ./src/arch/x86/stage2/kstdio.o
ST2_BIN=./stage2.bin
ST2_ELF=./stage2.elf
